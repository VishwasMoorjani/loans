...
class Product_model extends CI_Model
{
    ...
    public function getAllRecords($searchData)
    {
        ...
        $this->db->select('products.product_id,products.product_name,products.product_image,products.status as pstatus,products.in_stock,products.add_date,products.is_featured');
