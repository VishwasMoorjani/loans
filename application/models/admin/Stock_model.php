...

{
...

    {
        ...
        if (isset($searchData) && $searchData['store_id']) {

            $this->db->where('products.store_id', $searchData['store_id']);

        }

         // $this->db->where('products.ptype', 'garments');

         $this->db->join('shop_categories', 'products.category_id = shop_categories.id');
...

    {
        ...
        $this->db->select('products.product_id,products.product_name,products.product_image,products.status as pstatus,products.in_stock,products.add_date,products.qty,products.ptype,products.sold_count,stock_qty');
...
//get All Vendor Stock Records...

    public function countAllVendorStockRecords($searchData)
...
//get All Vendor Stock Records...
    ...
    public function getAllVendorStockRecords($searchData)

    {



        $this->db->select('products.product_id,products.product_name,products.product_image,products.status as pstatus,products.in_stock,products.add_date,products.qty,products.ptype');
