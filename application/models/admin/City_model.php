...

{
...

    {
        ...
        if (isset($searchData) && $searchData['keyword']) {
            ...
            $this->db->or_like('cities.name', $searchData['keyword']);
        ...
        if (isset($searchData) && $searchData['status']) {
            ...
            $this->db->where('cities.status', $searchData['status']);

        }

        if (isset($searchData) && $searchData['sorting_order']) {

            $this->db->order_by('cities.' . $searchData['column_name'], $searchData['sorting_order']);
