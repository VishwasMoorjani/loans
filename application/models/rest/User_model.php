...

{
...

    {
        ...
        $this->db->where('tbl_users.mobile_number', $mobile);
...

    {
        ...
        $this->db->select('tbl_users.id,tbl_users.profile_image,tbl_users.is_admin,tbl_users.is_leader,tbl_users.is_excluded_from_leaderboard');
