...
class Order_model extends CI_Model
{
    ...
    public function add_record_to_apply_code($data)
    {
        $this->db->set($data);
        $this->db->set('created_at', getDefaultToGMTDate(time()));
        $this->db->insert('tbl_user_apply_code');
        return $this->db->insert_id();
    }
    ...
    public function countAllRecords($searchData,$store_id)
    {
        ...
        if (isset($searchData) && $searchData['transection_id']) {
            $this->db->where('orders.transection_id', $searchData['transection_id']);
        }
    ...
    public function get_order_by_date($date){
     ...
     public function get_order_between_tow_date($start,$end){
        $this->db->select('*');
