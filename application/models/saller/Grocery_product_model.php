...
class Grocery_product_model extends CI_Model
{
    ...
    public function getAllRecords($searchData)
    {
        ...
        $this->db->select('products.product_id,products.product_name,products.product_image,products.status as pstatus,products.in_stock,products.add_date,products.mrp,products.sale_price,products.discount,products.sub_category,products.sub_sub_category');
