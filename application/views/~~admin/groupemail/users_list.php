...
<div class="card search-panel ">
  <div class="card-body">
    ...
    <a href="<?php echo site_url() ?>admin/staff/add" class="btn btn-success float-right rounded-0"><i class="fas fa-plus-circle"></i></a>
    <br>
    <br>
        ...
        <table class="table">
          <thead class="thead-white">
            <tr>
              ...
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="full_name"><span id="full_name">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Name</th> 
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="email"><span id="email">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Eamil</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="mobile_number"><span id="name">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Mobile</th>

              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="mobile_number"><span id="name">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Role</th>

              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="status"><span id="is_status">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Status</th>
...
function sortByColumnName($this) {
      ...
      var surl = site_url+'admin/staff/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
