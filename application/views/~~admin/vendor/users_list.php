...
<div class="card search-panel ">
  <div class="card-body">
    ...
    <a href="<?php echo site_url() ?>admin/vendor/add" class="btn btn-success float-right rounded-0"><i class="fas fa-plus-circle"></i></a>
    <br>
    <br>
    <div class="row mb-3">
...
function sortByColumnName($this) {
      ...
      var surl = site_url+'admin/vendor/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
