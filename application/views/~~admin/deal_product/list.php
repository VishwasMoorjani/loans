...
<div class="card search-panel ">
  <div class="card-body">
    <h5 class="card-title" style="display: inline-block;"><?php echo $page_title; ?></h5>
      <a href="<?php echo site_url() ?>admin/deal_product/add" class="btn btn-success float-right rounded-0"><i class="fas fa-plus-circle"></i></a>
    <br>
    <br>
    <div class="row mb-3">
      ...
      <div class="admin_table table-responsive">
        <table class="table">
          <thead class="thead-white">
            <tr>
              <th>#</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="title"><span id="title">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Product Name</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="title"><span id="title">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Image</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="title"><span id="title">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Deal Price</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="title"><span id="title">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Start</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="title"><span id="title">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;End</th>
...
function sortByColumnName($this) {
      ...
      var surl = site_url+'admin/deal_product/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
