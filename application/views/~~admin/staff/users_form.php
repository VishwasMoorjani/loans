	...
	<div class="path">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item" aria-current="page"> Registration Staff</li>
			</ol>
		</nav>
	</div>
</div>
...
<div class="container-fluid">
	<div class="content_container">
		...
		<div class="form_container">
			...
			<?php if (!$id) {?>
			<form class="ajax_form" method="post" action="<?php echo site_url() ?>admin/staff/add">
				<?php } else {?>
				<form class="ajax_form" method="post" action="<?php echo site_url() ?>admin/staff/update/<?php echo $id ?>">
					<?php }?>
					<div class="card-body">
					...
					<div class="border-top">
						<div class="card-body">
							...
							<?php } ?>
							<a href="<?php echo site_url() ?>admin/staff" class="btn btn-info pull-right rounded-0 back">Back</a>
						</div>
					</div>
				</form>
			</div>
