...
<div class="card search-panel ">
      ...
      <div class="admin_table table-responsive">
        <table class="table">
          <thead class="thead-white">
            <tr>
              <th>#</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="title"><span id="title">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Title</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="content"><span id="content">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Content</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="link_text"><span id="link_text">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Link</th>
  ...
  var surl = site_url+'admin/home_middle_section/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
