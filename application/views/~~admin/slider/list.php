...
<div class="container-fluid">
  <div class="path">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:">School</a></li>
...
<div class="card search-panel ">
  <div class="card-body">
    ...
    <a href="<?php echo site_url() ?>admin/slider/add" class="btn btn-success float-right rounded-0"><i class="fas fa-plus-circle"></i></a>
    <br>
    <br>
    <div class="row mb-3">
      ...
      <div class="col-lg-3 col-md-6 my-2">
        <input type="text" class="form-control" placeholder="Search By title" id="keyword">
      </div>
        ...
        <table class="table">
          <thead class="thead-white">
            <tr>
              ...
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="is_status"><span id="is_status">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Status</th>
...
var surl = site_url+'admin/slider/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
