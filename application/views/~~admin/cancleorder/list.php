...
function sortByColumnName($this) {
      ...
      var surl = site_url+'admin/cancleorders/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
...

{
    ...
    var column_name = 'cancle_order_date';
...
var address = $($this).data('address');
  ...
  $.ajax({
    ...
    url: site_url + "admin/cancleorders/get_address?id=" + address,
