...
function sortByColumnName($this) {
      ...
      var surl = site_url+'admin/returnorder/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
...
var address = $($this).data('address');
  $.ajax({
    url: site_url + "admin/returnorder/get_address?id=" + address,
    type: 'get',
    dataType: 'json',
    beforeSend: function() {
      $('.lodding').css('display', 'block');
