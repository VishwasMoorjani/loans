...
<div class="container-fluid">
    <div class="content_container">
        ...
        <div class="form_container">
            ...
            <?php if (!$id) {?>
            <form class="ajax_form" method="post" action="<?php echo site_url() ?>admin/brand/add">
                <?php } else {?>
                <form class="ajax_form" method="post" action="<?php echo site_url() ?>admin/brand/update/<?php echo $id ?>">
                    <?php }?>
                    <div class="card-body">
