...
<div class="card search-panel ">
  <div class="card-body">
    <h5 class="card-title" style="display: inline-block;"><?php echo $page_title; ?></h5>
      <a href="<?php echo site_url() ?>admin/wallet/add" class="btn btn-success float-right rounded-0"><i class="fas fa-plus-circle"></i></a>
    <br>
    <br>
    <div class="row mb-3">
        ...
        <table class="table">
          <thead class="thead-white">
            <tr>
              <th>S.No.</th>
              <th >
                <span id="type`">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;User Name
              </th>
              <th >
                <span id="amount">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Debit Amount</th>
              <th>
                <span id="valid_from_date">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp; Credit Amount</th>
              <th>
                <span id="valid_to_date">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp; Description</th>
              <th>
                <span id="add_date">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Add Date
              </th>
              <th>Action</th>
            </tr>
          </thead>
...
function sortByColumnName($this) {
      ...
      var surl = site_url+'admin/wallet/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
