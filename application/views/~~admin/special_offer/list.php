...
<div class="card search-panel ">
        ...
        <table class="table">
          <thead class="thead-white">
            <tr>
              ...
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="percent"><span id="percent">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Off</th>
  ...
  var surl = site_url+'admin/special_offer/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
