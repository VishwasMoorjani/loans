...
<div class="container-fluid">
    ...
    <div class="content_container">
        ...
        <div class="form_container">
            ...
            <form class="ajax_form" method="post" action="<?php echo site_url() ?>admin/discount/add">

                <?php } else {?>

                <form class="ajax_form" method="post" action="<?php echo site_url() ?>admin/discount/update/<?php echo $id ?>">
                    ...
                    <div class="border-top">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?php echo site_url() ?>admin/discount" class="btn btn-info pull-right rounded-0 back">Back</a>
