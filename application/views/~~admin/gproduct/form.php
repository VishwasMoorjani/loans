...
<div class="container-fluid">
    <div class="content_container">
        ...
        <div class="form_container">
            ...
            <?php if (!$id) {?>
            <form class="ajax_form" method="post" action="<?php echo site_url() ?>admin/grocery_product/add">
                <?php } else {?>
                <form class="ajax_form" method="post" action="<?php echo site_url() ?>admin/grocery_product/update/<?php echo $id ?>">
                    <?php }?>
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select  class="form-control input-xsmall input-inline select2" id="sub_category" name="sub_category" onChange="get_sub_sub_category(this)" >
                                    ...
                                    <option value="<?php echo $value->id;?>" <?php if($value->id==$sub_category_id){echo "selected";} ?>><?php echo strtoupper($value->title);?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <!--                         <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select  class="form-control input-xsmall input-inline select2" id="sub_sub_category" name="sub_sub_category" >
                                    ...
                                    <option value="<?php //echo $value->id;?>" <?php if($value->id==$sub_sub_category_id){echo "selected";} ?>><?php echo strtoupper($value->title);?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div> -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select  class="form-control input-xsmall input-inline select2" id="taxes_id" name="taxes_id" >
                                    ...
                                    <option value="<?php echo $value->id;?>" <?php if($value->id==$taxes_id){echo "selected";} ?>><?php echo strtoupper($value->title);?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" value="Yes" name="is_cap_product" <?php if($is_cap_product=="Yes"){echo "checked";} ?>>Yes
                                    </label>
                                </div>
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" value="No" name="is_cap_product" <?php if($is_cap_product=="No"){echo "checked";} ?>>No
                                    </label>
                                </div>
                            </div>
