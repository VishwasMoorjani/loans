...
<div class="card search-panel ">
  <div class="card-body">
    ...
    <a href="<?php echo site_url() ?>admin/grocery_product/add" class="btn btn-success float-right rounded-0"><i class="fas fa-plus-circle"></i></a>
    <!-- <a href="<?php echo site_url() ?>admin/grocery_product/bulkupload" class="btn btn-secondary float-right rounded-0"><i class="fas fa-upload"></i> Bulk Upload</a> -->
    <br>
    <br>
    <div class="row mb-3">
      ...
      <?php $category = get_all_parent();  ?>
            <div class="col-lg-1 col-md-1 my-2">
        <select name="cagetory" class="form-control input-xsmall input-inline select2" id="category" onchange="searchRecords(this)">
        ...
        <table class="table">
          <thead class="thead-white">
            <tr>
              ...
              <th>Image</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="mrp"><span id="mrp">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;MRP</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="sale_price"><span id="sale_price">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Sale Price</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="discount"><span id="discount">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Discount</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="custom_product_id"><span id="custom_product_id">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Product ID</th>
...
function sortByColumnName($this) {
      ...
      var surl = site_url+'admin/grocery_product/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
...
function searchRecords()
{
    ...
    var column_name = 'custom_product_id';
    $(".lodding").css('display','block');
    var selfOrInCricle = $('#selfOrInCricle').val();
    var category = $('#category').val();
    var surl = site_url+'admin/grocery_product/get_ajax_list?keyword='+keyword+'&category='+category+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form class="ajax_form" method="post" action="<?php echo site_url() ?>admin/grocery_product/addColor">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="form-group row">
            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Select <?php echo $record->varient_key ?></label>
            <div class="col-sm-6">
          ...
          <div class="form-group row">
            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Select <?php echo $record->varient_key2 ?></label>
            <div class="col-sm-6">
