            ...
            <form class="form-horizontal ajax_form" action="<?php echo site_url('admin/user/changePasswordForAdmin'); ?>" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="Email" class="col-sm-3 text-right control-label col-form-label">Miminum order</label>

                        <div class="col-sm-5">

                            <input type="text" class="form-control" id="mini_order" placeholder="Miminum order" name="mini_order" value="<?php echo $mini_order ?>">
                        ...
                        <label for="Email" class="col-sm-3 text-right control-label col-form-label">Shipping charges</label>

                        <div class="col-sm-5">

                            <input type="text" class="form-control" id="Shipping charges" placeholder="Shipping charges" name="shipping_charges" value="<?php echo $shipping_charges ?>">
                        ...
                        <label for="Email" class="col-sm-3 text-right control-label col-form-label">Varient Key</label>

                        <div class="col-sm-5">

                            <input type="text" class="form-control" id="Varient1 charges" placeholder="Varient 1" name="varient_key" value="<?php echo $varient_key ?>">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="text" class="form-control" id="Varient2 charges" placeholder="Varient 2" name="varient_key2" value="<?php echo $varient_key2 ?>">
...
<!-- 
                ...
                <div class="border-top">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?php echo site_url() ?>admin/admin" class="btn btn-info pull-right rounded-0 back">Back</a>
