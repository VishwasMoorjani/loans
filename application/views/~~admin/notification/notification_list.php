...
<div class="container-fluid">
  <div class="card search-panel ">
    <div class="card-body">
      ...
      <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#Modal2">
      <i class="fas fa-share"></i>  Send Notification
      </button>
      <br>
      <br>
      <div class="row mb-3">
        ...
        <div class="admin_table table-responsive">
          <table class="table">
            <thead class="thead-white">
              <tr>
                <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="mobile"><span id="mobile"><i class="fa fa-sort" aria-hidden="true"></i></span> Mobile Number</th>
                <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="name"><span id="name"><i class="fa fa-sort" aria-hidden="true"></i></span>User Name</th>
                <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="email"><span id="email"><i class="fa fa-sort" aria-hidden="true"></i></span>Email</th>
                ...
                <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="created_at"><span id="add_date"><i class="fa fa-sort" aria-hidden="true"></i></span> Add Date</th>
              </tr>
            </thead>
    ...
    var surl = site_url+'admin/pushnotification/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
    ...
    <div class="modal fade" id="Modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <form class="ajax_form" action="<?php echo site_url('admin/pushnotification/send_notification'); ?>" method="post">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Send Notification From</h5>
            ...
            <div class="modal-body">
              ...
              <div class="form-group row">
                <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Message</label>
                <div class="col-sm-9">
                  <select class="form-control" style="width: 100%; height:36px;" data-select2-id="1" tabindex="-1" aria-hidden="true" name="user_type">
                    <option data-select2-id="3" value="" >Select</option>
                    <option value="users" data-select2-id="17">All Users</option>
                    <!-- <option value="vendors" data-select2-id="18">All Vendors</option> -->
