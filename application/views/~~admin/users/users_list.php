  ...
  <div class="card-body">
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-3 col-md-6 my-2">
        ...
        <input type="text" class="form-control" placeholder="Search By mobile" id="mobile">
    ...
    <a href="<?php echo site_url() ?>/admin/users/export">Export</a>
  </div></div></div>
...
function sortByColumnName($this) {
      ...
      var surl = site_url+'admin/users/get_ajax_list?mobile='+mobile+'&keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
