...
function sortByColumnName($this) {
      ...
      var surl = site_url+'admin/stock/get_viewstock?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name+'&vendorid='+vendorid;
...
function searchRecords()
{
    ...
    var surl = site_url+'admin/stock/get_viewstock?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name+'&saller='+saller+'&vendorid='+vendorid;
