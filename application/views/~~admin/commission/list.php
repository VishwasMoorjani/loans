...
function sortByColumnName($this) {
      ...
      $("#created_at").html('<i class="fa fa-sort" aria-hidden="true"></i>');
      ...
      var surl = site_url+'admin/commission/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
