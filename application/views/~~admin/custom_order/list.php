...
<!--     <a href="<?php echo site_url() ?>admin/custom_order/add" class="btn btn-success float-right rounded-0"><i class="fas fa-plus-circle"></i></a>
    <br>
    <br> -->
    <div class="row mb-3">
...
var surl = site_url+'admin/custom_order/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
