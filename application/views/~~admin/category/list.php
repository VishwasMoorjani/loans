...
<div class="card search-panel ">
  ...
  <div class="card-body">
    ...
    <h5 class="card-title" style="display: inline-block;"><?php echo $page_title; ?></h5>
      ...
      <a href="<?php echo site_url() ?>admin/category/add" class="btn btn-success float-right rounded-0"><i class="fas fa-plus-circle"></i></a>
        ...
        <table class="table">
          ...
          <thead class="thead-white">
            ...
            <tr>
              ...
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="title"><span id="title">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Main Category</th>
...
function sortByColumnName($this) {
      ...
      var surl = site_url+'admin/category/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
