	...
	<div class="col-md-12">
		...
		<div class="portlet box grey-cascade">
			<div class="portlet-title">
				<div class="caption"><i class="icon-docs"></i>List of email templates</div>
			</div>
			<div class="portlet-body">
				<div class="table-toolbar">
					...
					<div class="row">
						<div class="col-md-12">			
							...
							<div onClick="checkForNullChecked('Active',this,'mail template')" data-taskurl="<?php echo base_url('admin/mail_templates/multiTaskOperation'); ?>" class="btn green tooltips" data-original-title="Active selected record">Active <i class="fa fa-check"></i></i>
							 </div>

							 <div style="margin-left:10px;" onClick="checkForNullChecked('Inactive',this,'mail template')" data-taskurl="<?php echo base_url('admin/mail_templates/multiTaskOperation'); ?>" class="btn purple tooltips" data-original-title="Inactive selected record">Inactive<i class="fa fa-ban"></i></div>
					...
					<table class="table table-striped table-bordered table-hover" id="sample_3">
						...
						<tbody>
							<?php foreach ($templates as $key => $value) { ?>
								...
								<td>
									<?php echo show_limited_text($value->name,25); ?>
								</td>
								<td>
									<?php echo show_limited_text($value->subject,25); ?>
								</td>			
								<td>
									<div class="btn-group">
