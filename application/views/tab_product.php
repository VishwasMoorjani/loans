                                ...
                                <div class="no-slider row">
                                        ...
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="<?php echo assets_panel; ?>images/pro3/27.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="<?php echo assets_panel; ?>images/pro3/28.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="<?php echo assets_panel; ?>images/pro3/1.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="<?php echo assets_panel; ?>images/pro3/2.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="<?php echo assets_panel; ?>images/pro3/33.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="<?php echo assets_panel; ?>images/pro3/34.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="<?php echo assets_panel; ?>images/pro3/35.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="<?php echo assets_panel; ?>images/pro3/36.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
