        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form method="post" name="EmpForm" action="<?php echo base_url(); ?>main/newEmployee/SaveData" enctype="multipart/form-data" id="newEmp">
                            <div class="row">
                                <div class="col-md-3">
                                    <?php $lastEMPid = $this->db->order_by('user_id', 'DESC')->get('tbl_users')->row_array(); ?>
                                    <div class="form-group">
                                        <label>Employee ID:</label>
                                        <input type="text" name="emp_id" value="SSMSF0<?php echo $lastEMPid['user_id'] + 1; ?>" placeholder="Employee ID" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group" id="Name">
                                        <label>Name:</label>
                                        <input type="text" name="name" placeholder="Employee Name" class="form-control" id="name" pattern="[a-zA-Z][a-zA-Z ]+" title="Accept only alphabet">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group" id="Email">
                                        <label>Email:</label>
                                        <input type="email" name="email" placeholder="Employee Email" class="form-control" id="email">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group" id="Mobile">
                                        <label>Mobile:</label>
                                        <input type="text" name="mobile" placeholder="Employee Mobile" class="form-control" id="mobile" pattern="[0-9]+" title="Acceot Only Number">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group" id="Password">
                                        ...
                                        <input type="password" name="password" placeholder="Employee Password" class="form-control" id="password">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group" id="Aadhar">
                                        ...
                                        <input type="text" name="aadhar" placeholder="Employee Aadhar No." class="form-control" id="aadhar">
                                    ...
                                    <div class="form-group" id="auth">
                                        ...
                                        <select class="form-control" name="authority" id="authority">
                                            ...
                                            if ($this->session->userdata('user_type') == "super_admin") {
                                                ...
                                                $users = $this->db->get_where('tbl_users', array('user_status' => 1, 'user_branch' => $this->session->userdata('user_branch')))->result_array();
                                            }
                                        ...
                                        <span class="help-block" for="authError" style="display:none">Reporting Auth. is Required*</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <br />
                            <center><button type="button" id="SaveData" class="btn-primary"><i class="fa fa-save"></i> Save Data</button></center>
                        </form>
                    </div>
                </div>
            </div>
        ...
        $('#SaveData').attr('disabled',true);
          ...
          error = true;
            ...
            if (ephoto == "") {
                ...
                $('span[for="ephotoError"]').text("Employee Photo is Required*");
                $('#ephoto').val('');
                $('#ephoto').focus();
                          $('#SaveData').attr('disabled',false);
          $('#SaveData').html('<i class="fa fa-save"></i> Save Data<i>');
