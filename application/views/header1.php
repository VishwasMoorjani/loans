                                ...
                                <div id="mySidenav" class="sidenav">
                                    ...
                                    <nav>
                                                ...
                                                foreach ($category as $cat ) {
                                                    ...
                                                    <li> 
                                                        ...
                                                        <ul class="mega-menu clothing-menu">
                                                            <li>
                                                                <div class="row m-0">
                                                                    <?php if(isset($cat['subcategory'])){
                                                                    foreach ($cat['subcategory'] as $sc ) {
                                                    ?>
                                                                    <div class="col-xl-4">
                                                                        <div class="link-section">
                                                                            <h5><?php echo $sc['title'] ?></h5>
                                                                            <?php if (isset($sc['sub_sub_category'])) {
                                                                                ?><ul>
                                                                                <?php
                                                                ...
                                                                <?php }
                                                                    ...
                                                                    <div class="col-xl-4">
                                                                        <a href="#" class="mega-menu-banner"><img
                                                                            src="<?php echo assets_panel; ?>images/mega-menu/fashion.jpg"
                                        ...
                                        <div class="brand-logo">
                                            <a href="index.html"><img src="<?php echo assets_panel; ?>images/icon/logo.png"
                                                                                                        ...
                                                                                                        <div class="icon-nav">
                                                                                                            <ul>
                                                                                                                <li class="onhover-div mobile-search">
                                                                                                                    <div><img src="<?php echo assets_panel; ?>images/icon/search.png" onclick="openSearch()"
                                                                                                                        ...
                                                                                                                        <li class="onhover-div mobile-setting">
                                                                                                                            <div><img src="<?php echo assets_panel; ?>images/icon/setting.png"
                                                                                                                            ...
                                                                                                                            <li class="onhover-div mobile-cart">
                                                                                                                                <div><img src="<?php echo assets_panel; ?>images/icon/cart.png"
                                                                                                                                    class="img-fluid blur-up lazyload" alt=""> <i
                                                                                                                                        ...
                                                                                                                                        <li>
                                                                                                                                            <div class="media">
                                                                                                                                                <a href="#"><img alt="" class="mr-3"
                                                                                                                                                    src="<?php echo assets_panel; ?>images/fashion/product/1.jpg"></a>
                                                                                                                                                ...
                                                                                                                                                <li>
                                                                                                                                                    <div class="media">
                                                                                                                                                        <a href="#"><img alt="" class="mr-3"
                                                                                                                                                            src="<?php echo assets_panel; ?>images/fashion/product/2.jpg"></a>
                                                                                                                                                            <div class="media-body">
                                                                                                                                                                <a href="#">
                                                                                                                                                                    <h4>item name</h4>
                                                                                                                                                                </a>
