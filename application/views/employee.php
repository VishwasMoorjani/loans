              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="row">
                    <div class="col-md-4">
                      <?php $CI=&get_instance();?>
                      <h5><b>Department:</b> <?php $dept=$CI->getDepartment($user_department); echo $dept['department_name'];?></h5></div>
                    <div class="col-md-4"><h5><b>Role:</b> <?php $role=$CI->getRole($user_role); echo $role['role_name'];?></h5></div>
                    <div class="col-md-4"><h5><b>Reporting:</b> <?php $auth=$CI->getAuthority($user_reporting); echo $auth['user_name'];?></h5></div>
                  </div>
                  <br/>
                  <div class="row">
                    <div class="col-md-3">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      ...
                      <p><?php if($user_status==0){ echo '<label class="label label-danger">Suspended</label>';} 
                      if($user_status==1){ echo '<label class="label label-success">Active</label>'; }
                  ?></p>
                    </div>
                  </div>
                  <br/>
