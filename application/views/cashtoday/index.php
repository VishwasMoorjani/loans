 ...
 <div class="col-md-5">
    ...
    <script type="text/javascript">
        ...
        function sortByColumnName($this) {
            ...
            var surl = site_url + '/main/get_today_cash_ajax_list?date=' + date + '&page_limit=' + page_limit + '&sorting_order=' + sorting_order + '&column_name=' + column_name;
        ...
        function searchRecords() {
            ...
            var surl = site_url + '/main/get_today_cash_ajax_list?page_limit=' + page_limit + '&sorting_order=' + sorting_order + '&column_name=' + column_name+'&hidden_start_date='+hidden_start_date+'&hidden_end_date='+hidden_end_date+'&sagent='+sagent;
