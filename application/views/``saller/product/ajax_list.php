  ...
  <td>
    ...
    <div class="btn-group">
      ...
      <div class="dropdown-menu">
        ...
        <a  class="dropdown-item" href="javascript:" data-id="<?php echo $value->product_id; ?>" data-url="<?php echo site_url('saller/product/change_stock_status'); ?>" data-status="1" onClick="changeStatusCommon(this)">In Stock</a>
        <a  class="dropdown-item" href="javascript:" data-id="<?php echo $value->product_id; ?>" data-url="<?php echo site_url('saller/product/change_stock_status'); ?>" data-status="0" onClick="changeStatusCommon(this)">Out of Stock</a> </div>
      </div>
    </td>
    ...
    <td>
      <ul class="list-unstyled d-flex mb-0">
        ...
        <li> <a href="javascript:" class="delete_btn" data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="deleteUser(this)" data-id="<?php echo $value->product_id;  ?>" data-customer="<?php echo $value->product_id;  ?>" data-url="<?php echo base_url('saller/product/delete') ?>"><i class="far fa-trash-alt"></i></a> </li>

        <li> <a href="<?php echo site_url()?>saller/product/product_images/<?php echo $value->product_id ?>" class="view_btn" title="Add Images" data-toggle="tooltip"><i class="far fa-images"></i></a> </li>
