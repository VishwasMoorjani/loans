...
<div class="card search-panel ">
  <div class="card-body">
    <h5 class="card-title" style="display: inline-block;"><?php echo $page_title; ?></h5>
      <a href="<?php echo site_url() ?>saller/product/add" class="btn btn-success float-right rounded-0"><i class="fas fa-plus-circle"></i></a>
    <br>
    <br>
    <div class="row mb-3">
...
function sortByColumnName($this) {
      ...
      var surl = site_url+'saller/product/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
...
<script type="text/javascript">
  function addEditColor(id) {
        $.ajax({
          url: site_url + "saller/product/product_puchease/" + id,
          type: 'get',
          dataType: 'json',
          beforeSend: function() {},
          complete: function() {},
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form class="ajax_form" method="post" action="<?php echo site_url() ?>saller/product/addColor">
      <div class="modal-content">
        <div class="modal-header">
  ...
  function getColor($this) {
    ...
    var product_id = $('#product_idhide').val();
        $.ajax({
          url: site_url + "saller/product/product_variation/" + purchase_id+"/"+product_id,
          type: 'get',
          dataType: 'json',
          beforeSend: function() {},
          complete: function() {},
