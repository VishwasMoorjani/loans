...
<script type="text/javascript">
  function sortByColumnName($this) {
    ...
    var surl = site_url + 'saller/orders/get_ajax_list?keyword=' + keyword + '&page_limit=' + page_limit + '&sorting_order=' + sorting_order + '&column_name=' + column_name;
  ...
  function searchRecords() {
    ...
    var surl = site_url + 'saller/orders/get_ajax_list?keyword=' + keyword + '&transection_id=' + transection_id + '&page_limit=' + page_limit + '&sorting_order=' + sorting_order + '&column_name=' + column_name;
...
<script type="text/javascript">
  function showAddress($this) {
    ...
    var id = $($this).data('id');
    $.ajax({
      url: site_url + "saller/orders/get_address?id=" + address + "&order_id=" + id,
      type: 'get',
      dataType: 'json',
      beforeSend: function() {
        $('.lodding').css('display', 'block');
...
<script type="text/javascript">
  ...
  function exp() {
    ...
    if (date == "") {
      ...
      window.location.href = site_url + 'saller/orders/export?start=' + date;
    }
  }
</script>
<script type="text/javascript">
...
<script type="text/javascript">
  function exp2() {
    ...
    window.location.href = site_url + 'saller/orders/exportorder?hidden_start_date=' + hidden_start_date + '&hidden_end_date=' + hidden_end_date;
