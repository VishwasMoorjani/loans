...
foreach ($product as $key => $value) {
  $total_item_purchease += $value->qty; 
}
    //pr($billing_address);
 ?>
  ...
  <div class="path">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"> <?php echo $page_title; ?> <?php $newTime = strtotime('-30 minutes');  date("g:i:s",$newTime) ;?></li>
      </ol>
    </nav>
  </div>
</div>
          ...
          <div class="">
            <div class="box">
              <div class="box-header with-border">
                <div class="box-title"> Invoice Number #<?php echo $order->id; ?>
                </div> <a title="Print Order" href="<?php echo site_url() ?>admin/orders/invoice/<?php echo $order->id ?>"  class="btn btn-md btn-default pull-right"><i class="fas fa-file-invoice"></i></a> 
              </div>
              <div class="box-body">
...
<?php if($order->order_source!="mobile"){ ?>
  ...
  <?php } else { ?>
        <td>
    <p><b>Customer Names :</b><?php echo $billing_address->shipping_name ?></p>
    <p><b>Customer Mobile :</b><?php echo $billing_address->shipping_phone ?></p>
