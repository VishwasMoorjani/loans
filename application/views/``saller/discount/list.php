...
<div class="card search-panel ">
  <div class="card-body">
    <h5 class="card-title" style="display: inline-block;"><?php echo $page_title; ?></h5>
      <a href="<?php echo site_url() ?>saller/discount/add" class="btn btn-success float-right rounded-0"><i class="fas fa-plus-circle"></i></a>
    <br>
    <br>
    <div class="row mb-3">
      ...
      <div class="col-lg-3 col-md-6 my-2">
        <input type="text" class="form-control" placeholder="Search By code" id="keyword">
      </div>
      ...
      <div class="admin_table table-responsive">
        <table class="table">
          <thead class="thead-white">
            <tr>
              <th>#</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="code"><span id="code">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Code</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="type"><span id="type`">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Type</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="amount"><span id="amount">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Amount</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="valid_from_date"><span id="valid_from_date">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Valid from date</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="valid_to_date"><span id="valid_to_date">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Valid to date</th>
...
function sortByColumnName($this) {
      ...
      var surl = site_url+'saller/discount/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
