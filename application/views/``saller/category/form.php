...
<div class="container-fluid">
    <div class="content_container">
        ...
        <div class="form_container">
            ...
            <?php if (!$id) { ?>
                <form class="ajax_form" method="post" action="<?php echo site_url() ?>saller/category/add">
                <?php } else { ?>
                    <form class="ajax_form" method="post" action="<?php echo site_url() ?>saller/category/update/<?php echo $id ?>">
                    <?php } ?>
                    <div class="card-body">
                    ...
                    <div class="border-top">
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <a href="<?php echo site_url() ?>saller/category" class="btn btn-info pull-right rounded-0 back">Back</a>
                        </div>
                    </div>
                    </form>
        </div>
