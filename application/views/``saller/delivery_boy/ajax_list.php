...
<tr>
  ...
  <td><?php echo ucfirst($value->user_phone); ?></td>
  ...
  <td>
    ...
    <td>
      <ul class="list-unstyled d-flex mb-0">
        <li> <a href="<?php site_url(); ?>delivery_boy/update/<?php echo $value->id ?>" class="edit_btn" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fas fa-pencil-alt"></i></a> </li>
        <li> <a href="javascript:" class="delete_btn" data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="deleteUser(this)" data-id="<?php echo $value->id;  ?>" data-customer="<?php echo $value->id;  ?>" data-url="<?php echo base_url('admin/delivery_boy/delete') ?>"><i class="far fa-trash-alt"></i></a> </li>
      </ul>
    </td>
  </tr>
  <?php  $i++;} }else{ ?>
