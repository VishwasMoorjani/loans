...
<div class="card search-panel ">
  <div class="card-body">
    <h5 class="card-title" style="display: inline-block;"><?php echo $page_title; ?></h5>
      <a href="<?php echo site_url() ?>saller/delivery_boy/add" class="btn btn-success float-right rounded-0"><i class="fas fa-plus-circle"></i></a>
    <br>
    <br>
    <div class="row mb-3">
      ...
      <div class="admin_table table-responsive">
        <table class="table">
          <thead class="thead-white">
            <tr>
              <th>#</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="user_name"><span id="user_name">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Name</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="user_email"><span id="user_email">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Email</th>
              <th onclick="sortByColumnName(this);" data-sorting_order="ASC" data-column_name="user_phone"><span id="user_phone">&nbsp;<i class="fa fa-sort" aria-hidden="true"></i></span>&nbsp;Phone</th>
...
function sortByColumnName($this) {
      ...
      var surl = site_url+'saller/delivery_boy/get_ajax_list?keyword='+keyword+'&page_limit='+page_limit+'&sorting_order='+sorting_order+'&column_name='+column_name;
