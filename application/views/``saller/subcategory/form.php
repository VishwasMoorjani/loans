...
<div class="container-fluid">
    <div class="content_container">
        ...
        <div class="form_container">
            ...
            <?php if (!$id) { ?>
                <form class="ajax_form" method="post" action="<?php echo site_url() ?>saller/sub_category/add">
                <?php } else { ?>
                    <form class="ajax_form" method="post" action="<?php echo site_url() ?>saller/sub_category/update/<?php echo $id ?>">
                    <?php } ?>
                    <div class="card-body">
