    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Company User types</li>
            </ol>
        </section>
        <!-- Main content -->
        <section class="content container-fluid">
            <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <h4 class="box-title">New User type</h4>
                            </div>
                            <div class="box-body">
                                <form method="post" action="newusertype/newusertype">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="branch" placeholder="User type" class="form-control" required pattern="[a-zA-Z][a-zA-Z ]+" title="Accept only alphabet" />
                                    </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h4 class="box-title">All User Type</h4>
                        </div>
                        <div class="box-body table-responsive">
                            <table id="table" class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $i = 0;
                                    $branches = $this->db->get(' tbl_user_type')->result_array();
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (in_array('blockBranch', $permissions)) { ?>
                                                    <?php if ($branch['status'] == 1) { ?>
                                                        <a href="<?php echo base_url(); ?>main/newusertype/Status/<?php echo $branch['id']; ?>/0"><button class="btn-warning" title="Inactive Now"><i class="fa fa-ban"></i></button></a>
                                                    <?php } else { ?>
                                                        <a href="<?php echo base_url(); ?>main/newusertype/Status/<?php echo $branch['id']; ?>/1"><button class="btn-success" title="Activate Now"><i class="fa fa-check"></i></button></a>
                                                    <?php } ?>
                                                <?php } ?>
                                            ...
                                            <div class="modal modal-primary fade" id="EditBranch<?php echo $branch['id']; ?>">
                                                <div class="modal-dialog">
                                                    <form method="post" action="newusertype/UpdateUserType">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" style="background: #fff !important; color: #000 !important;">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="branch" class="form-control" name="branch" required>
                                                                        <option value="">Select Branch</option>
                                                                        <?php $branchdd = $this->db->get_where('tbl_branches', array('branch_status' => 1))->result_array();
                                                                        foreach ($branchdd as $br) : ?>

                                                                            <option value="<?php echo $br['branch_id']; ?>" <?php if ($br['branch_id'] == $branch['branch_id']) {
                                                                                                                                echo "selected";
                                                                ...
                                                                <div class="form-group">
                                                                    <label>User type:</label>
                                                                    <input type="text" name="title" value="<?php echo $branch['title']; ?>" placeholder="User type" class="form-control" required pattern="[a-zA-Z][a-zA-Z ]+" title="Accept only alphabet" />
                                                                </div>
                                                            </div>
