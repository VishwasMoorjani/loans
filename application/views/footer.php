 <!-- footer -->
                ...
                <div class="row footer-theme partition-f">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo"><img src="<?php echo assets_panel; ?>images/icon/logo.png" alt=""></div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="payment-card-bottom">
                            <ul>
                                <li>
                                    <a href="#"><img src="<?php echo assets_panel; ?>images/icon/visa.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?php echo assets_panel; ?>images/icon/mastercard.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?php echo assets_panel; ?>images/icon/paypal.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?php echo assets_panel; ?>images/icon/american-express.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?php echo assets_panel; ?>images/icon/discover.png" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="modal-bg">
                                    ...
                                    <div class="offer-content"> <img src="<?php echo assets_panel; ?>images/Offer-banner.png"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-12">
                            <div class="quick-view-img"><img src="<?php echo assets_panel; ?>images/pro3/1.jpg" alt=""
            ...
            <div class="setting-body">
                ...
                <div class="buy_btn">
                    ...
                    <a href="https://themeforest.net/item/multikart-responsive-angular-ecommerce-template/22905358?s_rank=3"
                        target="_blank" class="btn btn-block purchase_btn"><img src="<?php echo assets_panel; ?>images/icon/angular.png"
                    ...
                    <a href="https://themeforest.net/item/multikart-responsive-react-ecommerce-template/23067773?s_rank=2"
                        target="_blank" class="btn btn-block purchase_btn"><img src="<?php echo assets_panel; ?>images/icon/react.png"
                    ...
                    <a href="https://themeforest.net/item/multikart-multipurpose-shopify-sections-theme/23093831?s_rank=1"
                        target="_blank" class="btn btn-block purchase_btn"><img src="<?php echo assets_panel; ?>images/icon/shopify.png"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="modal-bg">
                                    ...
                                    <div class="media">
                                        <img src="<?php echo assets_panel; ?>images/stop.png"
   ...
   <!-- <div class="addcart_btm_popup" id="fixed_cart_icon">
    ...
    <!-- latest jquery-->
    <script src="<?php echo assets_panel; ?>js/jquery-3.3.1.min.js"></script>

    <!-- fly cart ui jquery-->
    <script src="<?php echo assets_panel; ?>js/jquery-ui.min.js"></script>

    <!-- exitintent jquery-->
    <script src="<?php echo assets_panel; ?>js/jquery.exitintent.js"></script>
    <script src="<?php echo assets_panel; ?>js/exit.js"></script>

    <!-- popper js-->
    <script src="<?php echo assets_panel; ?>js/popper.min.js"></script>

    <!-- slick js-->
    <script src="<?php echo assets_panel; ?>js/slick.js"></script>

    <!-- menu js-->
    <script src="<?php echo assets_panel; ?>js/menu.js"></script>

    <!-- lazyload js-->
    <script src="<?php echo assets_panel; ?>js/lazysizes.min.js"></script>

    <!-- Bootstrap js-->
    <script src="<?php echo assets_panel; ?>js/bootstrap.js"></script>

    <!-- Bootstrap Notification js-->
    <script src="<?php echo assets_panel; ?>js/bootstrap-notify.min.js"></script>

    <!-- Fly cart js-->
    <script src="<?php echo assets_panel; ?>js/fly-cart.js"></script>

    <!-- Theme js-->
    <script src="<?php echo assets_panel; ?>js/script.js"></script>
